...
export default function RequirementSummary({ user, dayDoc }) {
  ...
  return (
    <section className="mt-6">
      <div className="mb-2 text-xs uppercase tracking-wide text-gray-500">Compare</div>
      <div className="grid gap-3 sm:grid-cols-2">
        <div className="rounded-xl border border-gray-200 bg-white p-4">
          <div className="text-sm font-semibold text-gray-800 mb-2">Your Daily Requirement</div>
          <div className="grid grid-cols-2 gap-3">
            <Stat label="Calories" value={Math.round(userReq.calories || 0)} />
            <Stat label="Protein"  value={`${Math.round(userReq.protein  || 0)} g`} />
        ...
        <div className="rounded-xl border border-gray-200 bg-white p-4">
          <div className="text-sm font-semibold text-gray-800 mb-2">Planned Today</div>
          <div className="grid grid-cols-2 gap-3">
